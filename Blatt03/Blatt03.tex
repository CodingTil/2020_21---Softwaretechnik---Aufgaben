...
\begin{document}
	...
	\section*{Aufgabe 3.1}
	    \includegraphics[scale=0.93]{../src/03_1_Statechart.pdf}
	\section*{Aufgabe 3.2}
	\subsection*{a)}
	    \includegraphics[scale=0.8]{../src/03_2a_Classdiagramm.pdf}
	\subsection*{b)}
	    \begin{enumerate}
	        \item[1)] Es bietet sich an das Entwurfsmuster Koordinator zu verwenden, da bei dem Modell die Problemstellung \glqq eine Assoziation besitzt Attribute, die zu keiner der beteiligten Klassen gehören\grqq \space behoben wird.
	        \newpage
	        \item[2)] \leavevmode\vadjust{\vspace{-\baselineskip}}\newline
	        \includegraphics[scale=0.78]{../src/03_2b_Classdiagramm.pdf}
	    \end{enumerate}
	\subsection*{c)}
	    \begin{enumerate}
	        \item[1)] Die Kollegin hat das Entwurfsmuster \glqq Wechselnde Rolle\grqq \space umgesetzt.
			\item[2)] Die Anforderung lautete, dass eine Person sowohl Student, als auch Student und Mitarbeiter sein kann.
