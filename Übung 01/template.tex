...
\begin{document}
	...
	*A=Analyse; E=Entwurf; I=Implementierung; T=Test/Integration; W=Wartung\\
	...
	\textbf{Product Owner}
	\begin{itemize}
		\item Aktivitäten: Sprint Review, Sprint Retrospective, Daily Scrum
		\item Artefakte: Product Backlog, auslieferbares Produkt
	\end{itemize}
	\textbf{Scrum Master}
	\begin{itemize}
		\item Aktivitäten: Sprint Review, Sprint Retrospective, Daily Scrum
		\item Artefakte: Product Backlog, Sprint Backlog
	\end{itemize}
	\textbf{Dev Team}
	\begin{itemize}
		\item Aktivitäten: Sprint Planning, Sprint Review, Sprint Retrospective, Daily Scrum
		\item Artefakte: Product Backlog, Sprint Backlog
	\end{itemize}
