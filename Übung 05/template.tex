...
\begin{document}
    ...
    \renewcommand{\labelenumi}{\alph{enumi})}
		\begin{enumerate}
            \item Ist noch nicht so ganz passabel: \\
                \includegraphics[scale=1]{Aufgabe 5.1 a) Class Diagramm.png}
			\item \begin{enumerate} 
					\item[1)] Rolle?
					\item[2)] 
				\end{enumerate}
			\item \begin{enumerate} 
				\item[1)] Es handelt sich um das Entwurfsmuster Komposition
				\item[2)] i) und ii) wären mögliche Instanziierungen
				\item[3)] Die Objektdiagramme i) und ii) sind äquivalent.
				\end{enumerate}
		\end{enumerate}

	\section*{Aufgabe 5.2}
    \includegraphics[scale=1]{Aufgabe 5.2 Use Case Diagramm.png}
        
    \section*{Aufgabe 5.3}
    \includegraphics[scale=0.8]{Aufgabe 5.3 Statechart.png}

    \section*{Aufgabe 5.4}
    \includegraphics[scale=0.8]{Aufgabe 5.4 Class Diagramm.png}
