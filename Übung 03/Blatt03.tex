...
\begin{document}
	...
	\subsection*{b)}
	    \begin{enumerate}
	        \item[1)] Es bietet sich an das Entwurfsmuster Koordinator zu verwenden, da bei dem Modell die Problemstellung \glqq eine Assoziation besitzt Attribute, die zu keiner der beteiligten Klassen gehören\grqq.
	        \newpage
