...
\begin{document}
	...
	\section*{Aufgabe 3.1}
	\includegraphics[scale=0.2]{3.1 Statechart.png}

	\section*{Aufgabe3.2}
	\renewcommand{\labelenumi}{\alph{enumi})}
		\begin{enumerate}
			\item Klassendiagramm:\\ \includegraphics[scale=0.19]{3.2 a) UML-Classdiagramm.png}
			\item \begin{enumerate} 
					\item[1)] Es bietet sich an das Entwurfsmuster Koordinator zu verwenden, da bei dem Modell die Problemstellung "eine Assoziation besitzt Attribute, die zu keiner der beteiligten Klassen gehören".
					\item[2)] Klassendiagramm: \\ \includegraphics[scale=0.18]{3.2 c) UML-Classdiagramm with Koordinator-Class.png}
				\end{enumerate}
			\item \begin{enumerate} 
				\item[1)] Die Kollegin hat das Entwurfsmuster "Wechselnde Rolle" umgesetzt.
				\item[2)] Die Anforderung lautete, dass eine Person sowohl Student, als auch Student und Mitarbeiter sei kann.
				\end{enumerate}
		\end{enumerate}
\end{document}
