...
\begin{document}
    ...
    \section*{Aufgabe 9.2}
        \subsection*{a)}
            \includegraphics[scale=0.7]{Aufgabe 9.2 a).png}

        \subsection*{b)}
            \begin{enumerate}
                \item[(1)] Es gibt 4 gültige Konfigurationen.
                \item[(2)] Es gibt keine gültige Konfiguration.
                \item[(2)] Es gibt 6 gültige Konfigurationen. (unter der Annahme, dass die Tatsache, dass einige 
                Features denselben Namen haben, ignoriert werden kann)
            \end{enumerate}
